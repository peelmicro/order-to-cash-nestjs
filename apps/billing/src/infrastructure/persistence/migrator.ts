...
// artifact (same pattern as apps/orders / apps/fulfillment — see
// progress/impl_db_orders.md Decisions §6).
...
export async function runBillingMigrations(config: BillingDbConfig): Promise<void> {
