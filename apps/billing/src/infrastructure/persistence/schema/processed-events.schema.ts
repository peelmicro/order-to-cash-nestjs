...
//
// IDENTICAL shape to apps/orders' and apps/fulfillment's
// processed-events.schema.ts — copied verbatim per db_billing's task prompt
// (divergence between the three services' processed_events tables would be
// a defect).
