...
// Shared Testcontainers fixture for this service's NATS integration specs —
// real NATS, `nats:2.14.5-alpine`, the SAME pinned tag
// `docker-compose.infra.yml` uses, core-only (no JetStream).
//
// This fixture starts its OWN disposable container via Testcontainers,
// entirely independent of whatever `docker-compose.infra.yml` has running.
