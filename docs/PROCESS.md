...
**Position: Phase 7 of 25 complete, Phase 8 underway — 14 of 38 features done.**
...
| 8 | Orders service — `orders_aggregate` ✅, `outbox_and_idempotency` ✅ (the reliability spine); acceptance and saga orchestrator next | 🚧 |
